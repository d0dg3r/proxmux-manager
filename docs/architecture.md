...
- **Visual Asset Pipeline**: Store screenshots are generated by rendering the real popup UI with deterministic API/storage fixtures for cluster overview, connection onboarding, and settings view.
